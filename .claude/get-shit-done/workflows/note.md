...
- **Global scope**: `/Users/mac/Documents/Projects/Others/commamer/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/mac/Documents/Projects/Others/commamer/.claude/notes/`)
...
2. Glob `/Users/mac/Documents/Projects/Others/commamer/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/mac/Documents/Projects/Others/commamer/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/mac/Documents/Projects/Others/commamer/.claude/notes/` — works in any directory
