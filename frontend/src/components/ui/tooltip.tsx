  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          "z-50 w-fit origin-(--radix-tooltip-content-transform-origin) rounded-[var(--r-sm)] border border-[var(--border-strong)] bg-[var(--surface)] px-2.5 py-1.5 text-xs text-[var(--fg)] shadow-tooltip backdrop-blur-sm pointer-events-none",
